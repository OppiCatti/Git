...
public class CreateTweetDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
    	// we want to be generic. So, we expect the content in "contentTwitter" variable.
    	// the process designer should use an Input to map the input to the process variable he wants
    	String content = (String) execution.getVariable("contentTwitter");
